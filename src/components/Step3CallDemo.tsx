...
const Step3CallDemo: React.FC<StepProps> = ({ userData, setUserData, onNext }) => {
    ...
    <div className="max-w-xl mx-auto">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-md mb-6">
        <p className="text-lg text-gray-800 leading-relaxed">
          Our AI is demonstrating how it would call your leads within minutes of them visiting your website. 
          This technology converts 21x more leads by engaging them during the critical response window.
        </p>
      </div>

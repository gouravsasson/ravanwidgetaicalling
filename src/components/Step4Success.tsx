...
const Step4Success: React.FC<StepProps> = ({
  userData,
  setUserData,
  onNext,
}) => {
  ...
  const { callResult } = useCallResultStore();
  console.log(callResult?.data?.transcription);
  ...
  return (
    <div className="max-w-xl mx-auto text-center">
      ...
      <p className="text-xl text-gray-600 leading-relaxed mb-8 max-w-lg mx-auto">
        You've just witnessed how Ravan.ai can transform your website visitors
        into qualified leads and booked appointments using our revolutionary AI
        technology.
      </p>
      ...
      {/* <div className="w-full bg-gradient-to-br from-white to-gray-50 border border-gray-100 rounded-3xl p-7 shadow-lg mb-8">
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          One of our AI solution specialists will contact you shortly to discuss
          how we can implement this technology for your{" "}
          {categories[userData.selectedCategory] || "business"} and answer any
          questions you may have.
        </p>
      </div> */}
      <TranscriptChat messages={callResult?.data?.transcription} />
